...
enum GameTheme {
    ...
    static let subheadingFont = Font.custom("LoveYaLikeASister-Regular", size: 28)
    static let bodyFont = Font.custom("LoveYaLikeASister-Regular", size: 24)
    static let buttonFont = Font.custom("LoveYaLikeASister-Regular", size: 20)
    static let captionFont = Font.custom("LoveYaLikeASister-Regular", size: 16)
}
